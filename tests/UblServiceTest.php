...
class UblServiceTest extends TestCase
{
    ...
    public function testFromInvoice(): void
    {
        ...
        $invoice->legalMonetaryTotal->payableAmount = AmountHelper::fetchFromValue(1.0, Amount::class);

        $invoiceLine = new InvoiceLine();
        $invoiceLine->invoicedQuantity = QuantityHelper::fetchFromValue(1, Quantity::class);
        $invoiceLine->price = new Price();
        $invoiceLine->price->priceAmount = AmountHelper::fetchFromValue(1.0, Amount::class);
