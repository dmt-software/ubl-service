...
class InvoiceTypeCode implements CommonBasicComponent, Stringable
{
    #[XmlValue(cdata: false)]
    #[Type(name: 'enum<' . InvoiceType::class . '>')]
    public null|InvoiceType $code = InvoiceType::CommercialInvoice;
